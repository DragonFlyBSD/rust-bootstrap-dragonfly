--- tests/debuginfo/borrowed-c-style-enum.rs.orig
...
+//@ gdb-check:$3 = borrowed_c_style_enum::[...]TheC
 ...
 // === LLDB TESTS ==================================================================================
--- tests/debuginfo/c-style-enum.rs.orig
...
+//@ gdb-check:$18 = c_style_enum::[...]OneMillion
 ...
 // === LLDB TESTS ==================================================================================
--- tests/debuginfo/c-style-enum-in-composite.rs.orig
...
--- tests/debuginfo/gdb-pretty-struct-and-enums.rs.orig
...
--- tests/debuginfo/pretty-std.rs.orig
